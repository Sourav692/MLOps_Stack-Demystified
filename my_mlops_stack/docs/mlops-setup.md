...
git add README.md docs .gitignore my_mlops_stack/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. Verify that you're an admin by viewing the
  [staging workspace admin console](https://adb-2753962522174656.16.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-2753962522174656.16.azuredatabricks.net#setting/accounts). If
...
If you want to use different catalog names, please update the target names declared in the[my_mlops_stack/databricks.yml](../my_mlops_stack/databricks.yml) file.
...
Follow the instructions in [my_mlops_stack/resources/README.md](../my_mlops_stack/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../my_mlops_stack/resources/README.md)  to propose, test, and deploy
