...
Opening a pull request will trigger a[workflow](../.github/workflows/my_mlops_stack-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-2753962522174656.16.azuredatabricks.net/ml/models/staging-my_mlops_stack-model)
* [Prod workspace registered model](https://adb-2753962522174656.16.azuredatabricks.net/ml/models/prod-my_mlops_stack-model). 
